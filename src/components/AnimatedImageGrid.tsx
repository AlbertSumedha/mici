    ...
    <div className="animated-image-grid-container relative py-12 px-4 overflow-hidden">
      ...
      <div className="grid-header mb-12 relative z-10 text-center">
        <h2 className="grid-title text-white font-bold tracking-tight">
          <span className="title-line block text-3xl md:text-5xl">You Made My World</span>
          <span className="title-line block text-3xl md:text-5xl">Even More</span>
          <span className="title-line block text-3xl md:text-5xl text-pink-600">Beautiful</span>
        </h2>
      </div>
            ...
            */}
            <div className="image-container h-full w-full p-3 flex flex-col">
              <div className="relative flex-grow overflow-hidden rounded-xl aspect-square">
                ...
                <div className={`image-overlay absolute inset-0 bg-black/60 flex flex-col items-center justify-center transition-opacity duration-300 p-4 text-center ${
