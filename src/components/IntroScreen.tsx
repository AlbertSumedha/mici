...
const IntroScreen: React.FC<IntroScreenProps> = ({ onEnter }) => {
  ...
  return (
    <div className="intro-screen" style={{ 
      ...
      <div className="balloons-container" style={{ 
        position: 'absolute', 
        inset: 0, 
        zIndex: 2, 
        pointerEvents: 'none'
      ...
      <div className="intro-content" style={{ 
        ...
        <h1 className="intro-title" style={{ 
          ...
          Something Special
          <br />
          <span className="intro-subtitle" style={{ fontSize: '0.6em', opacity: 0.9 }}>
            Awaits You
          </span>
        </h1>
      ...
      {/* 5. EFEK SPARKLES */}
      <div className="intro-sparkles" style={{ position: 'absolute', inset: 0, zIndex: 2, pointerEvents: 'none' }}>
        {[...Array(12)].map((_, i) => (
